...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['organization-owner', 'mentor', 'admin', 'corporate-recruiter'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    },
    {
      ...
      path: '/corporate-recruiters',
      entity: 'corporate_recruiter',
      service: AccessServiceEnum.PROJECT,
      icon: FiUserPlus,
    },
    { name: 'Mentor', path: '/mentors', entity: 'mentor', service: AccessServiceEnum.PROJECT, icon: FiUserCheck },
    { name: 'Student', path: '/students', entity: 'student', service: AccessServiceEnum.PROJECT, icon: FiBookOpen },
