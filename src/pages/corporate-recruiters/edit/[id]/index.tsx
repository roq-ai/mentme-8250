...
import { getCorporateRecruiterById, updateCorporateRecruiterById } from 'apiSdk/corporate-recruiters';
...
function CorporateRecruiterEditPage() {
  ...
  const handleSubmit = async (values: CorporateRecruiterInterface, { resetForm }: FormikHelpers<any>) => {
    setFormError(null);
    try {
      const updated = await updateCorporateRecruiterById(id, values);
      mutate(updated);
      resetForm();
